    ...
    <div className="doc-permission permission-card">
      ...
      <div className="bx">
        ...
        >
          ...
          <option value="2">2 [HOD's] default (staff) </option>
          <option value="4">4 [Supervisors] default (staff) </option>
          <option value="5">5 [School Officer] </option>
          <option value="6">6 [Course advisor] </option>
          <option value="7">7 [External Supervisor] </option>
        </select>
      </div>
      <br />
